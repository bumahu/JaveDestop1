 ...
 * @author Admin
 */
public class flowlayoutform extends javax.swing.JFrame {

    /**
     * Creates new form flowlayoutform
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(flowlayoutform.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new flowlayoutform().setVisible(true);
            }
        });
    }
